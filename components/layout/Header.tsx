...
export default function Header() {
  ...
  return (
    <header className="bg-white/95 backdrop-blur-sm border-b border-neutral-200 sticky top-0 z-50">
      <nav className="container-max flex items-center justify-between p-6 lg:px-8" aria-label="Global">
        <div className="flex lg:flex-1">
          <Link href="/" className="-m-1.5 p-1.5 flex items-center space-x-2">
            <Flower2 className="h-8 w-8 text-primary-500" />
            <span className="font-serif text-2xl font-semibold text-neutral-900">Serenity Spa</span>
          </Link>
        </div>
        ...
        <div className="lg:hidden">
          ...
          <div className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-neutral-900/10">
            <div className="flex items-center justify-between">
              <Link href="/" className="-m-1.5 p-1.5 flex items-center space-x-2">
                <Flower2 className="h-8 w-8 text-primary-500" />
                <span className="font-serif text-xl font-semibold">Serenity Spa</span>
              </Link>
              <button
                type="button"
